...
- Kernel Size (*F*): The spatial dimensions of the filter (e.g., 3 × 3).
...
Instead of flattening the 14 × 14 × 256 tensor—which would result in 50,176 features and millions of parameters in the subsequent dense layer—GAP calculates the spatial average of each of the 256 channels. This operation yields a compact 1 × 1 × 256 vector. This design choice is parameter-free, significantly reduces the computational footprint, and acts as a strong structural regularizer against overfitting.
