Always read @Report_Guide.md before start 
Keep you answer simple, response in VietNamese
Follow the specifications and documentation in these files as sources to follow:
